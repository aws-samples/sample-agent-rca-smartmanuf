...
```bash
agentcore invoke '{"step": "step1", "prompt": "Investigate quality deviation on product NEXUS CK MB Reference 30421. Lot 1009900940 reported calibration error B18 on primary signal exceeding 550 SIU specification limit."}'
```
